...
From Table 5:
    ...
    * Helping others (helpfrds, peoptrbl), giving to the homeless, volunteering in charity, self-importance (selffrst, careself) are all concepts that have a significant relationship with political orientation.
    * Donating blood, loaning items, and allowing others to cut ahead in line do not have a significant relationship.
